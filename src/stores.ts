...
const config = writable<Config>({color: "#000000", background_color: "#E1E3EA", tool: 'PEN', strokeColor: null, strokeWidth: DEFAULT_STROKE_WIDTH, eraserSize: DEFAULT_ERASER_SIZE, strokeShape: DEFAULT_STROKE_SHAPE, showGrid: false});
